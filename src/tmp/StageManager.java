...
public StageManager(SpriteTracker spTrk, MainStage parent, ClauseContainer myNode, EventHandler PressBox, EventHandler DragBox) {
    //view
    setJavaFXStageParent(parent);
...
public StageManager(SpriteTracker spTrk, MainStage parent, SpriteBox myBox, EventHandler PressBox, EventHandler DragBox) {
    setJavaFXStageParent(parent);
...
private void advanceSpritePositionHor() {
        if (this.spriteX>880) {
                this.spriteY=spriteY+190;
                this.spriteX=0;
            }
            else {
                spriteX = spriteX+65; //uniform size for now
            }
}
